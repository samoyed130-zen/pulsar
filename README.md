...
線は奥（画面の中心あたり）で生まれ、外へ**加速しながら伸びて**消えます。位置を時間の2乗で進めているのは、近づくものほど速く横切って見えるという遠近の効果をそのまま写すためです。等速で動かすと、放射状に並んだ棒が伸び縮みしているようにしか見えません。長さは外へ行くほど伸ばし、太さは逆に細くしています。カメラの脇を速く過ぎるものは、目にも写真にも長く薄い筋として残るからです。
