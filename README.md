...
- **一本指で左右に動かす** : 動かした量だけ自機が回ります。画面のどこを触っても構いません。
...
そこで指の端末だけ、**一本指を横に動かした量**で回すようにしました。画面のどこを触っていても構いません。画面の幅いっぱいで半周と少し（3.8 ラジアン）回ります。1周を超えると、どちらへ動かしたのか分からなくなるためです。
