...
光を足すぶん、**ゲートの明度は先に下げて**います。ゲートは彩度 90 で塗っているので、そこへ加算で光を重ねると、3色のうち強い色から先に 255 で頭打ちになり、色どうしの釣り合いが崩れて**色相そのものが動きます**（青緑が白緑に寄るなど）。足す前に半分まで下げておくと、色相のずれは 55 度から 19 度、彩度の落ちは 0.50 から 0.02 に収まります。下げたぶんは光が足し返すので、明るさは変わりません。背景は彩度も明度も低いのでこの細工は不要で、濃い色で塗っているゲートにだけ効かせています。
