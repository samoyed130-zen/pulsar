...
- 流れてくる**虹色の立方体**に触れると、持ち時間が5秒延びます。
- ぶつかっても終わりません。画面が赤く弾けて減速し、そのまま走り続けます。
- **ステージは全6つ。**持ち時間2分のあいだに 1000 進めば次のステージへ。先へ行くほど切れ目が狭くなり、隣り合う切れ目のずれが大きくなり、拾える立体が減り、速度も上がります。
...
感度・背景・開放済みステージの選択は端末に保存され、次回も維持されます。
