...
出どころは**画面の中心ではありません**。通路は奥行きに応じてねじれ、時間でうねっているので、ゲートが現れる場所＝消失点は左右上下へ動いています。風だけが画面の中心から湧いていると、そこだけ別の世界の絵が重なって見えます。そこで、線1本ずつが自分の奥行きでの**トンネルの芯**から出るようにしました。同じ奥行きのリングとぴったり同心になるので、風は通路そのものに沿って流れます。

このうねりの式は**1か所にまとめて**あります（`tunnelCenter`）。リングを描くときと風を出すときで別々に書くと、必ず食い違って別物が動き出すからです。
...
長さと濃さは**1本ずつ変えて**います。そろえると、放射状に等間隔で並んだ図形にしか見えません。長さは半径の 0.25〜0.78 倍、濃さは 0.35〜1.27 倍の幅で散らしてあり、濃い長い筋と薄い短い筋が混ざって初めて、離れた奥行きに散らばったものが流れているように見えます。
