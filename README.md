...
線は「少し前にいた位置」から「今の位置」まで引きます。ただし**1枚ぶんちょうどにはしません**。それはモーションブラーの定義そのもので、飛んでいるものではなく**残像**に見えてしまうからです。尾は約4枚ぶんに伸ばし、さらに**先端だけ濃く**して、進んでいる向きが読めるようにしています。

尾の長さは枚数ではなく**秒**で持っています。枚数で持つと、30 回/秒の端末では尾が倍の長さになり、見え方そのものが変わってしまうためです。

速さも一度落としました。速すぎると1本ずつを目が追えず、結局は画面全体が一様なブレに見えます。追える速さにしたうえで、勢いは**本数**で出しています。実測では、画面に映っているあいだに筋は 14px から 226px まで伸び、消える奥行き（投影が発散するので 0 にはできません）に届く頃にはすでに画面の外なので、**溶けて消えるのではなく飛び抜けて**いなくなります。
