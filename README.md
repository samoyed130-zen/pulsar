...
ここは物理ではなく勢いを見せる絵なので、**今の位置を中心へ向かって縮めた点**を尾の根元にしています。奥でも手前でも同じ細長さに見え、進むほど実際の長さは伸び、時間もフレームレートも関わりません。さらに**先端だけ濃く**して、進んでいる向きが読めるようにしています。実測では、尾は画面の高さの 0.11 倍から 0.52 倍まで伸びていきます。
