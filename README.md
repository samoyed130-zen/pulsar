...
彩度は面の向きによる差を作っていないため、単純に2倍で構いません。一方、**明るさを倍率で持ち上げるのは避けています。** 明るい面から順に上限へ張り付き、隣り合う面の差が消えて境目だけが段差として浮くためです。代わりに「上限までの残りに対して一定の割合（36%）を足す」形にしました。こうすると、いくら引き上げても上限には届かず、面どうしの明暗の前後関係も保たれます。暗い面ほど大きく持ち上がるので、沈んだ絵を起こす目的にも合っています。
