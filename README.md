...
ここは物理ではなく勢いを見せる絵なので、**今の位置を中心へ向かって縮めた点**を尾の根元にしています。奥でも手前でも同じ細長さに見え、進むほど実際の長さは伸び、時間もフレームレートも関わりません。濃さは根元から先端へ**1本の中で移り変わらせて**います。最初は先端に濃い線を重ねていたのですが、色の違う短い棒が乗っているようにしか見えませんでした。実測では、尾は画面の高さの 0.11 倍から 0.52 倍まで伸びていきます。
